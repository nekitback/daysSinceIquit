...
export default function PendingCounterCard({ 
  ...
  return (
    <div className="relative bg-white rounded-2xl shadow-lg border-2 border-blue-200 overflow-hidden animate-pulse-slow">
      <div 
      ...
      >
        ...
        {/* Placeholder Stats */}
        <div className="grid grid-cols-3 gap-4 pt-4 border-t border-gray-200 opacity-40">
          <div>
